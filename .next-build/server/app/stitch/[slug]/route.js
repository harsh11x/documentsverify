"use strict";(()=>{var e={};e.id=665,e.ids=[665],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5135:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>m,patchFetch:()=>b,requestAsyncStorage:()=>f,routeModule:()=>y,serverHooks:()=>v,staticGenerationAsyncStorage:()=>g});var a={};n.r(a),n.d(a,{GET:()=>u});var r=n(9303),i=n(8716),o=n(670);let l=require("node:fs/promises"),c=require("node:path");var d=n.n(c),p=n(7070);let s={"verify-truth":"verify-truth-monolithic-hero.html","certificate-verification":"certificate-verification.html","register-organization":"register-organization.html","digital-certificate-view":"digital-certificate-view.html"};async function u(e,{params:t}){let n=s[t.slug];if(!n)return new p.NextResponse("Not found",{status:404});let a=d().resolve(process.cwd(),"..","stitch-export","code",n);try{let e=await (0,l.readFile)(a,"utf8"),n=function(e,t){let n=`
<script>
  (function () {
    var pageSlug = ${JSON.stringify(t)};
    var apiBaseUrl = ${JSON.stringify("http://localhost:4000")};
...
</script>`;return e.includes("</body>")?e.replace("</body>",`${n}</body>`):`${e}${n}`}(e,t.slug);return new p.NextResponse(n,{headers:{"content-type":"text/html; charset=utf-8"}})}catch{return new p.NextResponse("Stitch export file missing",{status:500})}}let y=new r.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/stitch/[slug]/route",pathname:"/stitch/[slug]",filename:"route",bundlePath:"app/stitch/[slug]/route"},resolvedPagePath:"/Users/harshdev/Documents/Projects/docverifyblock/app/stitch/[slug]/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:f,staticGenerationAsyncStorage:g,serverHooks:v}=y,m="/stitch/[slug]/route";function b(){return(0,o.patchFetch)({serverHooks:v,staticGenerationAsyncStorage:g})}}};var t=require("../../../webpack-runtime.js");t.C(e);var n=e=>t(t.s=e),a=t.X(0,[276,972],()=>n(5135));module.exports=a})();